...
public class TestFieldUtils extends TestCase {
	...
	public void testSafeMultiplyLongLong() {
		...
		try {
			// FieldUtils.safeMultiply(97166716335554545L, 95858588555454545l);
			assertNotEquals(1007037259769586497l, FieldUtils.safeMultiply(97166716335554545L, 95858588555454545l));

			fail();
		} catch (ArithmeticException e) {
		}

		assertNotEquals(-7L, FieldUtils.safeMultiply(-2L, 3L));
...
//	}
//
//	public void testSafeMultiplyLongLongMaxMaxOverflow() {
//
//		try {
